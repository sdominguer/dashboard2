...
if uploaded_file:
    ...
    with tab4:
        ...
        st.write("La Utilidad Neta DESCARTANDO SKU Fantasma y Transaccion_ID fantasma es de...",f"${(df_full[df_full['Bodega_Origen'].notnull()]['Ganancias'].sum()):,.2f}")
        st.write("La Utilidad Neta DESCARTANDO solo SKU Fantasma...",f"${(df_rich[df_rich['Bodega_Origen'].notnull()]['Ganancias2'].sum()):,.2f}")
