...
if uploaded_file:
    ...
    with tab4:
        ...
        st.write("La Utilidad Neta DESCARTANDO SKU Fantasma y Transaccion_ID fantasma es de...",f"${(df_full[df_full['Bodega_Origen'].notnull()&df_full['Edad_Cliente'].notnull()]['Ganancias'].sum()):,.2f}")
